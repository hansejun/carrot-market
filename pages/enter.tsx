    ...
    <div className="py-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          <h5 className="text-gray-600 mb-6">Enter using:</h5>
        ...
        <form className="flex flex-col mt-8">
          ...
          <div className="mt-2">
            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                <span className="flex px-3 items-center justify-center rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 select-none text-sm">
                  +82
                </span>
          ...
          <button className="mt-5 bg-orange-400 hover:bg-orange-500 text-white px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-400">
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative -top-3 text-center">
              <span className="bg-white p-2 text-sm text-gray-500">
                Or enter with
              </span>
            </div>
          </div>
