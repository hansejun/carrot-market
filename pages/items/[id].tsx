    ...
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="mt-5 flex flex-col">
          ...
          <span className="text-3xl text-gray-900 mt-2">$140</span>
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 bg-orange-400 text-white py-3 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-400 font-medium hover:bg-orange-500">
              Talk to seller
            </button>
